export type WorkflowNodeType = 'cli.command' | 'ai.call' | 'file.read' | 'file.write' | 'condition' | 'loop' | 'delay' | 'n8n.webhook' | 'plugin.call' | 'control.start' | 'control.end' | 'notification';
